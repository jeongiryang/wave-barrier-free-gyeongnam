...
export const chapterIds = ["top", "regions", "story", "community", "departure", "naru", "features"];
export const chapterNames = {
  ko: ["처음", "이용 방법", "할 수 있는 일", "지역", "나루", "출발 전", "커뮤니티"],
  en: ["Welcome", "How it works", "What you can do", "Regions", "Naru", "Before you go", "Community"],
};
