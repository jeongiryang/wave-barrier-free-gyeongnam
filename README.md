...
> 참가 부문은 **① 웹·앱 개발 부문**, 1차 심사자료 마감은 **2026-09-21 16:00 KST**입니다. [공식 근거와 사람 확인 항목](docs/contest-compliance.md), [제출 초안](docs/submission/development-entry-draft.md)을 확인하세요. 미병합 후보의 CI 성공은 Production 반영을 뜻하지 않습니다.
