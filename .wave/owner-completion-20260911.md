...
18. ACTIVE — Explicit nearby-stop/arrival/route-direction lookup tied to saved public places, bounded provider use and separate route-origin timetable; implementation and focused release checks in progress.
