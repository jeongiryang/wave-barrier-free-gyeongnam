...
export default function PrivacyPage() {
  return <main className="policy-page" id="main">
    ...
    <div className="policy-grid">
      ...
      <section><h2>보관과 사용자 선택</h2><p>커뮤니티 글과 댓글은 사용자가 삭제하거나 운영 기준에 따라 숨길 수 있습니다. 공유 일정은 생성 시 안내된 기간 동안 보관됩니다. 비밀번호는 등록 이메일로 재설정할 수 있고, 계정 관리에서 탈퇴하면 인증 계정과 서버에 연결된 게시글·댓글·좋아요·신고를 함께 삭제합니다. 이 기기의 여행집과 환경설정은 브라우저 데이터이므로 별도로 지울 수 있습니다.</p></section>
