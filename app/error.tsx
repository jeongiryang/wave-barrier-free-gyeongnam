...
export default function ErrorPage() {
  ...
  return (
    <main className="route-state-page" lang={en ? "en" : "ko"} aria-labelledby="route-error-title">
      ...
      <span role="alert">{en ? "Reload the page or return to trip planning. The itinerary and conditions saved on this device will stay here." : "화면을 새로 불러오거나 여행 설계로 돌아가 주세요. 이 기기에 저장한 일정과 조건은 유지됩니다."}</span>
      <div>
