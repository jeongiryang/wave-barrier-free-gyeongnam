...
export default function TermsPage() {
  return <main className="policy-page" id="main">
    ...
    <div className="policy-grid">
      ...
      <section><h2>커뮤니티</h2><p>사용자 작성 경험은 공식 관광정보와 별도 출처로 표시됩니다. 개인정보, 권리 침해, 혐오·비방, 광고성 콘텐츠는 신고 또는 운영 검토에 따라 숨겨질 수 있습니다.</p></section>
      <section><h2>계정과 기능 범위</h2><p>계정은 커뮤니티 참여를 위한 선택 기능입니다. 가입·로그인·로그아웃, 등록 이메일을 통한 비밀번호 재설정, 로그인 뒤 비밀번호 변경과 계정 탈퇴를 제공합니다. 탈퇴하면 서버에 연결된 커뮤니티 데이터도 함께 삭제합니다. 여행 설계, 지도, 이 기기 일정과 공개 후기 읽기는 계정 없이 이용할 수 있습니다.</p></section>
