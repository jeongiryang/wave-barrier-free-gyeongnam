...
export default function TermsPage() {
  return <main className="wave-night night-secondary policy-page" id="main">
    ...
    <article className="policy-article policy-terms">
      <section id="terms-purpose"><p className="policy-section-kicker">제1조 · 목적과 서비스 범위</p><h2>여행 판단을 돕는 정보 서비스</h2><p>이 약관은 WAVE와 사용자의 서비스 이용 기준을 정합니다. WAVE는 경상남도 무장애 여행을 위해 공식 관광·편의·날씨·교통·지도 정보와 여행자 경험을 연결하고, 조건별 추천·일정·경로·공유 기능을 제공합니다.</p><p>WAVE는 한국관광공사, 경상남도, 지도·교통·숙박·시설 제공기관의 공식 운영 서비스가 아닙니다. 실제 예약, 운송, 시설 제공과 현장 안전에 관한 계약은 각 제공기관과 사용자 사이에 성립합니다.</p><p>출발 전 확인 목록은 사용자가 준비할 항목을 정리하는 선택 기능입니다. WAVE는 보험이나 금융 상품을 추천·비교·중개하지 않으며, 가입 또는 보장 여부를 판단하지 않습니다.</p><p>지역 상품 안내는 공식 외부 판매처 링크만 제공하며 W.A.V.E는 상품을 판매·중개하거나 결제·주문·배송·기부에 관여하지 않습니다.</p></section>
