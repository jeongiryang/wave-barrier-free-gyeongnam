...
export default function AccountPage() {
  return <AuthUtilityShell eyebrow="계정 관리" title="내 계정 설정" description="비밀번호 변경부터 탈퇴와 연결 데이터 정리까지 직접 결정할 수 있습니다."><AccountSettings nativeAuth={isKakaoAuthConfigured()} /></AuthUtilityShell>;
}
