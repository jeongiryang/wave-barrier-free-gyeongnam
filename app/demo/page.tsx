...
export default function DemoPage() {
  ...
  return <div className="wave-night night-secondary night-demo"><WaveHeader current="planner" /><main className="demo-page" id="demo-main"><header><span className="demo-badge">시연 모드</span><h1>예시 여행으로 먼저 해보세요</h1><p>가상 장소·편의시설·이동시간으로 구성했습니다. 실제 관광정보와 저장된 여행은 변경하지 않습니다.</p><a href="/planner">실제 여행 설계로 돌아가기 →</a></header>
