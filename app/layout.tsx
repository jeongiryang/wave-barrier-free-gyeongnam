...
const arrivalBootStyle = `#arrival-boot{display:none}html[data-intro-pending]{overflow:hidden}html[data-intro-pending] #arrival-boot{display:grid;position:fixed;inset:0;z-index:2147483647;place-content:center;background:#020817;color:#fff;font:700 32px system-ui}html[data-intro-pending] body>*:not(#arrival-boot){visibility:hidden}#arrival-boot button{position:absolute;top:16px;right:16px;min-height:44px;padding:8px 14px;border:0;border-radius:999px;background:transparent;color:#fff;font:16px system-ui;cursor:pointer}#arrival-boot button:hover,#arrival-boot button:focus-visible{color:#8de8ff;background:#12324980}#arrival-boot button:focus-visible{outline:3px solid #8de8ff;outline-offset:3px}`;
