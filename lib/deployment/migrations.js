export const PRODUCTION_MIGRATION_NAMES = Object.freeze([
  ...
  "006_retire_community_seed.sql",
  "007_account_deletion.sql",
  "008_review_date_integrity.sql",
  "011_account_travel.sql",
  "012_community_visit_photos.sql",
  "013_live_shared_trips.sql",
  "014_travel_experience.sql",
  "015_username_login.sql",
  "016_retire_test_posts.sql",
  "017_community_categories.sql",
  "017_community_travel_talk.sql",
  "018_community_field_report_kind.sql",
  "019_community_demo_metadata.sql",
]);
