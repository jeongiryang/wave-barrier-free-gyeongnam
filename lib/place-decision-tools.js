...
const facilityLabels = { parking: "장애인 주차", route: "접근로", wheelchair: "휠체어", elevator: "승강기", restroom: "장애인 화장실", stroller: "유모차", lactationroom: "수유실", babysparechair: "유아용 의자", braileblock: "점자블록", helpdog: "안내견", guidehuman: "안내요원", audioguide: "음성 안내", bigprint: "큰활자 안내", signguide: "수어 안내", videoguide: "영상 안내", hearingroom: "청각장애인 편의" };
