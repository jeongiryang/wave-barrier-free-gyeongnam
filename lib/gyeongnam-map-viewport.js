...
export function constrainedGyeongnamViewport(center, southWest, northEast) {
  // Leave room for the SDK's pixel rounding at the widest permitted zoom.
  const inset = .005;
  const b = { south: GYEONGNAM_MAP_BOUNDS.south + inset, west: GYEONGNAM_MAP_BOUNDS.west + inset, north: GYEONGNAM_MAP_BOUNDS.north - inset, east: GYEONGNAM_MAP_BOUNDS.east - inset };
