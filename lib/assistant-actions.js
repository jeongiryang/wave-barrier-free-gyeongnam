...
export const ASSISTANT_TOOLS = ['conditions', 'facilities', 'dates', 'places', 'itinerary', 'map', 'readiness', 'weather', 'transport', 'alternatives', 'comfort', 'budget', 'save', 'share', 'offline', 'calendar', 'on-trip', 'inquiry', 'compare', 'course', 'split'];
