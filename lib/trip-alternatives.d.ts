...
export type AlternativeCandidate = {
  place: Place; unknownKeys: string[]; distanceKm: number; travelMinutes: number | null; travelDelta: number | null;
...
export function alternativeCandidates(input: {
  ...
  indoorById?: Record<string, IndoorEvidence | undefined>; originalVisitMinutes?: number; includeUnknown?: boolean; limit?: number;
