export const GUIDANCE_PREFERENCES = ['briefAnswers', 'oneAtATime', 'textFirst'];
...
export function guidancePreferenceText(value) {
  ...
  return [safe.briefAnswers && '짧은 답변', safe.oneAtATime && '한 번에 하나씩', safe.textFirst && '문자 안내 우선'].filter(Boolean);
}
