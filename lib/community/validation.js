...
export function communityListParams(url) {
  ...
  return { category: COMMUNITY_CATEGORIES.includes(category) ? category : "", search, placeId, page, limit, offset: (page - 1) * limit, ...(placeId && url.searchParams.get("history") === "1" ? { history: true } : {}) };
}
