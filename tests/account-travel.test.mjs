...
test("account trip storage has an explicit field allowlist and rejects corrupt dates/IDs", () => {
  ...
  assert.deepEqual(Object.keys(safe).sort(), ["version", "title", "region", "travelStart", "travelEnd", "dayStartTime", "themes", "placeIds", "scheduleAssignments", "visitMinutesByPlaceId", "status", "note"].sort());
