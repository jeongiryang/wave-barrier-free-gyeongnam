...
export default function GithubFooterLink() {
  ...
  return <a className="github-footer-link" href={repositoryUrl} target="_blank" rel="noreferrer" aria-label={locale === "en" ? "Open the W.A.V.E GitHub repository" : "W.A.V.E GitHub 저장소 열기"} data-tooltip="GitHub">
