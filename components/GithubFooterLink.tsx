...
export default function GithubFooterLink() {
  ...
  return <a className="github-footer-link" href={repositoryUrl} target="_blank" rel="noreferrer" aria-label={locale === "en" ? "Open the WAVE GitHub repository" : "WAVE GitHub 저장소 열기"} data-tooltip="GitHub">
