...
- ODsay searchPubTransPathT hold 이슈 #454는 9월27일 실제 계정 한도 및 창원·통영 경로 재검증 후 종료했다. 주차 제공처의 응답 형식 오류는 별도로 진단 중이며, 경로 성공을 전체 운영 API 성공으로 해석하지 않는다. 현재 결과는 `docs/release-final-verification-20260927.md`와 후속 PR에 연결한다.
