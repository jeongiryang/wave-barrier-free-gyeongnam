...
- CI 35494821049의 유일한 flaky 검사였던 음성 입력의 경로 이동 검사는 URL 변경 뒤 React 경로 commit·effect cleanup을 기다리도록 동기화했다. abort 횟수, 늦은 음성 폐기 및 트랙 해제 조건을 유지하고 desktop/mobile 각 8회(총 16회) 반복 통과, 독립 QA 확인을 마쳤다.
