...
const chapters = [
  { label: "조건 고르기", title: ["가고 싶은 마음에서", "여행은 시작돼요"], copy: "경남 18개 시·군의 바다와 문화 숲길과 산책을 둘러보며 마음이 향하는 지역과 활동을 찾아보세요", en: ["Start with a place", "you want to go."], enCopy: "Explore Gyeongnam’s 18 regions. Choose where to go and the activities you enjoy.", tags: ["여행 지역", "여행 날짜", "하고 싶은 활동"], enTags: ["Region", "Dates", "Activities"] },
  { label: "편의 살피기", title: ["좋아하는 곳에", "필요한 편의까지"], copy: "접근로 화장실 승강기 등 내게 필요한 편의와 장소별 공식 정보를 함께 살피고 아직 확인되지 않은 정보도 구분해 보여드려요", en: ["The places you love.", "The facilities you need."], enCopy: "Compare paths, toilets and lifts with official information. Details that still need checking are shown separately.", tags: ["접근로·승강기", "장애인 화장실", "확인 범위"], enTags: ["Paths and lifts", "Accessible toilets", "Evidence"] },
  { label: "일정 담기", title: ["하루의 순서는", "내가 원하는 대로"], copy: "마음에 드는 장소를 담아 날짜와 방문 순서를 정하고 일정과 이동을 한곳에서 살피며 우리에게 맞는 여행을 만들어가요", en: ["Make room for", "your kind of day."], enCopy: "Save places, arrange dates and visiting order, then review your itinerary and journeys together.", tags: ["날짜별 일정", "방문 순서", "이동 확인"], enTags: ["Daily itinerary", "Visiting order", "Journeys"] },
];
