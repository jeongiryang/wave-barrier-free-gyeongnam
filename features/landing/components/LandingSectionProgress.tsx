...
export default function LandingSectionProgress() {
  ...
  return <nav className="story-progress" data-surface={current === 1 || current === 3 || current === 4 || current === 5 ? "light" : "dark"} hidden={intro} aria-label={en ? "Introduction sections" : "서비스 소개 페이지 탐색"}>
