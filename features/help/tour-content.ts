...
export const landingSteps: TourStep[] = [
  ...
  { selector: '#story', highlightSelector: '.night-journey-input', eyebrow: '일정 만들기', title: '날짜별로 장소를 담아보세요.', copy: '여행지 정보를 보고 담은 뒤 날짜와 시간을 정하세요. 일정과 지도는 함께 확인할 수 있어요.' },
...
export const communitySteps: TourStep[] = [
  ...
  { selector: ".night-community-toolbar", highlightSelector: ".night-community-toolbar", eyebrow: "정보 원칙", title: "후기는 공식 정보의 대체물이 아닙니다.", copy: "방문 전에는 운영기관의 최신 편의시설 정보를 다시 확인해 주세요." },
];
...
const englishTourCopy: Record<string, Pick<TourStep, "eyebrow" | "title" | "copy">> = {
  ...
  ".night-community-toolbar": { eyebrow: "Using information", title: "Stories do not replace official information.", copy: "Recheck the latest facility information with the place operator before visiting." },
