...
export default function SharedTripScreen() {
  ...
  return <main className="shared-trip-page">
    <header className="shared-header"><Link className="brand" href="/"><span className="brand-mark" aria-hidden="true"><i /><i /><i /></span><span>W.A.V.E</span></Link><Link href="/planner">내 여행 새로 만들기 ↗</Link></header>
