...
export default function SharedTripScreen() {
  ...
  return <main className="shared-trip-page">
    <header className="shared-header"><Link className="brand" href="/"><span className="brand-mark" aria-hidden="true"><i /><i /><i /></span><span>WAVE</span></Link><Link href="/planner">내 여행 새로 만들기 ↗</Link></header>
    ...
    <footer className="simple-footer shared-footer"><div className="brand footer-brand"><span className="brand-mark" aria-hidden="true"><i /><i /><i /></span><span>WAVE</span></div><div className="footer-notes"><p>누구나 원하는 곳으로, 경남 무장애 여행 길잡이</p><p className="trust-notice">공유 여행은 저장한 조건으로 최신 공식 관광정보를 다시 확인합니다.</p><PolicyFooterLinks /></div><div className="footer-meta"><GithubFooterLink /></div></footer>
  </main>;
}
