...
export type SharedTrip = {
  ...
  selections: { region?: string; theme?: string; themes?: string[]; profiles?: string[]; travelStart?: string; travelEnd?: string; dayStartTime?: string; scheduleAssignments?: Record<string, string>; visitMinutesByPlaceId?: Record<string, number> };
  origin?: { label?: string };
