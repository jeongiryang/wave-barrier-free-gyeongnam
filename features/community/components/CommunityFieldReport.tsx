...
export default function CommunityFieldReport({ post }: { post: CommunityPost }) {
  ...
  if (!fieldReports.length && !journalPlaces.length) return null;
  return <>
    ...
    {fieldReports.length > 0 && <section className="detail-field-report" aria-labelledby="detail-field-report-title">
