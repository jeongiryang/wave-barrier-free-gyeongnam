...
export default function CommunityBoardToolbar({ board }: { board: ReturnType<typeof useCommunityBoard> }) {
  ...
  return <>
    <div className="community-toolbar"><div><p className="section-kicker">COMMUNITY BOARD</p><h2 id="community-list-title">여행자 이야기</h2></div><a className="community-write" href={writeHref}>새 이야기 쓰기 <span aria-hidden="true">＋</span></a></div>
