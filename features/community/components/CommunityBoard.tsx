...
export default function CommunityPage({ initialPlace = null }: { initialPlace?: PlaceFilter | null }) {
  const {
    posts, category, setCategory, search, setSearch, placeFilter, setPlaceFilter,
    page, hasMore, state, message, load, writeHref, submitSearch,
  } = useCommunityBoard(initialPlace);
