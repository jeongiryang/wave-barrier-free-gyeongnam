export default function WeatherVisual({ code }: { code: number }) {
  ...
  const known = [0, 1, 2, 3].includes(code) || snow || rain || fog;
  const cloudy = known && code !== 0;
  return <svg className="weather-illustration" viewBox="0 0 160 130" aria-hidden="true">
    {known && code <= 2 && <g className="weather-sun"><circle cx="66" cy="51" r="25" fill="#ffd764" /><path d="M66 8v9m0 69v9M23 51h9m69 0h9M35 20l7 7m49 49l7 7M35 82l7-7m49-49l7-7" stroke="#ffd764" strokeWidth="5" strokeLinecap="round" /></g>}
    ...
    {!known && <text x="80" y="74" textAnchor="middle" fill="currentColor" fontSize="42">?</text>}
  </svg>;
}
