...
export default function PlaceDecisionDialog(props: PlaceDecisionDialogProps) {
  ...
  return <dialog className="place-modal native-place-dialog simple-place-pane" aria-labelledby="place-modal-title" ref={dialogRef}>
      ...
      <div className="modal-body">
        ...
        <details><summary>주차·입구·시설 미리보기</summary><Suspense fallback={<LoadingState>주차·입구 정보를 준비하고 있어요.</LoadingState>}><PlaceArrivalPreview place={place} onOpenRestrooms={onClose} /></Suspense></details>
