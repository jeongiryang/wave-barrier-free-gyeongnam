...
import PlaceCommunityStories from "../../community/components/PlaceCommunityStories";
  ...
  return <div className="modal-backdrop" role="presentation" onMouseDown={onClose}>
    <section className="place-modal" role="dialog" aria-modal="true" aria-labelledby="place-modal-title" onMouseDown={(event) => event.stopPropagation()} ref={dialogRef}>
      ...
      <div className="modal-body">
        ...
        <PlaceCommunityStories placeId={place.id} placeName={place.name} region={location} />
