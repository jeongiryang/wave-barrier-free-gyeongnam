...
export default function PlannerConditionsPanel(props: PlannerConditionsPanelProps) {
  ...
  return <div className="journey-workspace-block journey-conditions" id="conditions">
    ...
    {showAvailability && <Suspense fallback={<p role="status">검색 결과를 준비하고 있어요…</p>}><PlannerAvailability region={region} selected={selected} themes={guided && question === 1 ? [] : themes} /></Suspense>}
