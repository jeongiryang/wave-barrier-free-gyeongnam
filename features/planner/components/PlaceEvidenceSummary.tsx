...
export default function PlaceEvidenceSummary({ place }: { place: Place }) {
  ...
  return <>
    ...
    {typeof place.confidence === "number" && <div className="modal-confidence"><span><small>공식 정보에서 확인됨</small><b>{place.confidence}%</b></span><span><small>확인된 항목</small><b>{place.knownFields || 0}개</b></span><span><small>확인 필요</small><b>{place.unknownFields || 0}개</b></span></div>}
  </>;
}
