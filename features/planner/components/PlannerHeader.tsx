...
export default function PlannerReferenceChrome({ view, region, dates, facilities, activities, savedCount, activeStep, question, available, resultsAvailable, onQuestion, onNavigate, onSearch, searching, progress, requestState, recommendedCount }: {
  ...
  const current = activeStep === "conditions" ? question === 1 ? 1 : 0 : activeStep === "departure-readiness" ? 3 : 2;
  ...
  return <>
    ...
    {(view === "overview" || activeStep !== "conditions") && <div className="reference-search" role="group" aria-label="여행 검색 조건">
