  ...
  return <>
    <div className="control-panel profile-panel">
      ...
      <details className="travel-profile-card" suppressHydrationWarning>
        <summary><span><small>{en ? "Optional · saved only on this device" : "선택 사항 · 이 기기에만 저장"}</small><strong>{en ? "Save and load facilities" : "편의 조건 저장·불러오기"}</strong></span><b aria-hidden="true">+</b></summary>
