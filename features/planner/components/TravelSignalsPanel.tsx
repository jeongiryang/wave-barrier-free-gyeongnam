...
export default function TravelSignalsPanel({
  ...
  return <div className="travel-layers journey-workspace-part" id="layers">
    <div className="workspace-heading inverse journey-subheading" data-reveal>
      <div><span>상황</span><h2>{region} 상황과 여행 정보</h2></div>
      <p>날씨 · 방문 경향 · 주변</p>
    </div>
