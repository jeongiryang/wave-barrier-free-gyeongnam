...
export const courseCard={padding:'clamp(16px,3vw,28px)',border:'1px solid var(--line)',borderRadius:24,background:'var(--paper)',minWidth:0,display:'grid',gap:16} as const;
...
export const coursePrimary={background:'var(--accent)',color:'var(--onaccent)',borderColor:'var(--accent)'} as const;
